...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 20, 2021 lúc 04:02 PM
...
INSERT INTO `carts` (`id`, `customer_id`, `note`, `total_price`, `status`, `created_at`, `updated_at`) VALUES
(20, 24, 'sss', 3598000, 0, '2021-10-10 20:29:02', '2021-10-10 20:29:02');
...
(4, 20, 5, 2, 1799000, '2021-10-10 20:29:02', '2021-10-10 20:29:02');
...
(24, 'bùi đức phú', '0856800200', 'Ngõ 157b- Chùa Láng-Đống Đa-Hà Nội', 'admin@gmail.com', '2021-10-10 20:29:02', '2021-10-10 20:29:02');
...
(1, 'Buiducphu.266@gmail.com', NULL, '$2y$10$O7/CVcgHcV67lNroU/r..OLQzOGuByz7ZLe/9V2.skziMr7Nz8qZe', 'DaRwoS9wpbxNLw6HhnrbDWllqNta7AXeYARlz8cHn4Y2fKCjWf9AJbOtEkw8', NULL, NULL);
